/*!
 * Pusher JavaScript Library v1.11.1
 * http://pusherapp.com/
 *
...
(function(){function a(a,b,d){if(b[a]!==void 0)b[a](d)}function d(a,d,g){b.EventsDispatcher.call(this);this.state=void 0;this.errors=[];this.stateActions=g;this.transitions=d;this.transition(a)}var b=this.Pusher;d.prototype.transition=function(d,f){var g=this.state,h=this.stateActions;if(g&&b.Util.arrayIndexOf(this.transitions[g],d)==-1)throw Error("Invalid transition ["+g+" to "+d+"]");a(g+"Exit",h,f);a(g+"To"+(d.substr(0,1).toUpperCase()+d.substr(1)),h,f);a(d+"Pre",h,f);this.state=d;this.emit("state_change",
{oldState:g,newState:d});a(d+"Post",h,f)};d.prototype.is=function(a){return this.state===a};d.prototype.isNot=function(a){return this.state!==a};b.Util.extend(d.prototype,b.EventsDispatcher.prototype);this.Pusher.Machine=d}).call(this);
...
connectedPre:function(b){c.socket_id=b;c.socket.onmessage=y;c.socket.onerror=n;c.socket.onclose=m;a(c);c.connectedAt=(new Date).getTime();p()},connectedPost:function(){j("connected")},connectedExit:function(){c._activityTimer&&clearTimeout(c._activityTimer);j("disconnected")},impermanentlyClosingPost:function(){if(c.socket)c.socket.onclose=m,c.socket.close()},permanentlyClosingPost:function(){c.socket?(c.socket.onclose=function(){a(c);c._machine.transition("permanentlyClosed")},c.socket.close()):
...
(a(this),this._machine.transition("waiting"))};d.prototype.send=function(a){return this._machine.is("connected")?(this.socket.send(a),!0):!1};d.prototype.send_event=function(a,d,e){a={event:a,data:d};e&&(a.channel=e);b.debug("Event sent",a);return this.send(JSON.stringify(a))};d.prototype.disconnect=function(){this._machine.is("permanentlyClosed")||(this._machine.is("waiting")?this._machine.transition("permanentlyClosed"):this._machine.transition("permanentlyClosing"))};b.Util.extend(d.prototype,
b.EventsDispatcher.prototype);this.Pusher.Connection=d}).call(this);Pusher.Channels=function(){this.channels={}};Pusher.Channels.prototype={add:function(a,d){var b=this.find(a);b||(b=Pusher.Channel.factory(a,d),this.channels[a]=b);return b},find:function(a){return this.channels[a]},remove:function(a){delete this.channels[a]},disconnect:function(){for(var a in this.channels)this.channels[a].disconnect()}};
